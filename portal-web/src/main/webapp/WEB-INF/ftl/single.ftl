   ...
   <div class="movie_top">
		 <div class="col-md-9 movie_box">
				...
				<div class="desc1 span_3_of_2">
					...
					<p class="movie_option"><strong>类别: </strong><a href="#">Adventure</a>, <a href="#">Fantazy</a></p>
					<p class="movie_option"><strong>发布日期: </strong>December 12, 2014</p>
					<p class="movie_option"><strong>Director: </strong><a href="#">suffered </a></p>
					<p class="movie_option"><strong>演员: </strong><a href="#">anything</a>, <a href="#">Lorem Ipsum</a>, <a href="#"> discovered</a>, <a href="#"> Virginia</a>, <a href="#"> Virginia</a>, <a href="#">variations</a>, <a href="#">variations</a>, <a href="#">variations</a>, <a href="#"> Virginia</a> <a href="#">...</a></p>
